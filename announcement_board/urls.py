...
from board.views import (PosterList, PosterDetail, PosterCategory, AddPoster, ResponseCreate,
...
urlpatterns = [
    ...
    # path('accounts/signup/', NewSignupView.as_view(), name='account_signup'),
    # path('accounts/signup/', logup_view, name='account_signup'),
    path('register/', register_view, name='register'),
    path('verify/<int:user_id>/', verify_code_view, name='verify_code'),
    # path('accounts/login_with_code/', login_with_code_view, name='login_with_code'),
    path('pages/', include('django.contrib.flatpages.urls')),
    path('', PosterList.as_view(), name='posters'),

    # path('posters/', PosterList.as_view(), name='posters_list'),
    path('create/', AddPoster.as_view(), name='create'),
    path('posters/<int:pk>/', PosterDetail.as_view(), name='poster_detail'),
    path('users/<int:pk>/responses', ResponseList.as_view(), name='responses'),
