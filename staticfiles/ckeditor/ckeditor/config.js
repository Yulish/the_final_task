        ...
        'instanceReady': function(ev) {
            ...
            function setMediaAttributes() {
                ...
                for (let video of videos) {
                    video.setAttribute('width', '20%');
                    video.setAttribute('height', 'auto');
                    video.setAttribute('style', 'max-width: 100% !important; width: 20% !important; height: auto !important;');
                }
                ...
                for (let iframe of iframes) {
                    ...
                    iframe.setAttribute('style', 'max-width: 100% !important; width: 20% !important; height: auto !important;');
                }
            }
            setMediaAttributes();
